...
class MicropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      ...
      post microposts_url, params: { micropost: { content: "post4", user_id: @user.id } }
    end
  ...
  test "should update micropost" do
    patch micropost_url(@micropost), params: { micropost: { content: "updated post", user_id: @micropost.user_id } }
